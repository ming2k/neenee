...
| [0036](0036-cjk-wide-char-ghost-cells.md) | Heal CJK wide-character "ghost" cells with a whole-row re-emitting backend wrapper (`WideHealBackend`) so wide-glyph trailing columns stay fresh through tmux | Accepted |
