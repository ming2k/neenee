...
- [Harness architecture](../explanation/agent-design/harness.md) — control plane, provider calls, goal state, autonomous loop
...
- [Tool rounds](../explanation/agent-design/tool-rounds.md) — tool call lifecycle: declaration, gating, execution, and re-entry
